			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<c:choose>
						<c:when test="${user != null}">
							<li class="nav-item"><a class="nav-link"
								href="/TurismoApp/productos.do">Productos</a></li>
							<li class="nav-item"><a class="nav-link"
								href="itinerario.jsp">Itinerario</a></li>
							<c:if test="${user.getAdmin()}">
								<li class="nav-item"><a class="nav-link"
									href="/TurismoApp/administrar.do">Administrar</a></li>
							</c:if>
						</c:when>
						<c:otherwise>
				...
				<c:if test="${user != null}">
					<div class="info-usuario fs-5 ">
						...
						<i class="bi bi-piggy-bank-fill"> <c:out
								value="${user.getOro()}"></c:out></i> <i class="bi bi-clock-fill">
							...
							<button type="button" class="btn btn-primary"
								...
								<c:out value="${user.getName().toUpperCase()}"></c:out></button>

							
							

						</i>  <a href="/TurismoApp/logout"><i id="boton-logout"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Usuario: <c:out value="${user.getName().toUpperCase()}"></c:out></h5>
