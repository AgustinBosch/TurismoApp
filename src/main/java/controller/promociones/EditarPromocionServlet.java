...
@WebServlet("/editarPromo.do")
public class EditarPromocionServlet extends HttpServlet {

	private static final long serialVersionUID = -5801116646521668619L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Promo p = promocionService.buscarId(req.getParameter("id"));
		
		req.setAttribute("atracciones", atracciones);
		req.setAttribute("promocion", p);
		
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/views/promocion/editarPromo.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Promo p = promocionService.actualizar(id, tipo, genero, extra, descripcion, atracciones);
